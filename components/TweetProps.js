//earlier (static, immutable) version of Tweet.js where all properties are passed as props
        ...
        <UserIdentityBox>
          ...
          <NameContainer>
            ...
            <SettingsSVG>
              ...
              >
                <g fill="#8899A6">
                  <circle cx="5" cy="12" r="2" fill="#8899A6" />
                  <circle cx="12" cy="12" r="2" fill="#8899A6" />
                  <circle cx="19" cy="12" r="2" fill="#8899A6" />
                </g>
              </svg>
            </SettingsSVG>
          </NameContainer>
